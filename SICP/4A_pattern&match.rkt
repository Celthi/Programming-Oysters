...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 4A_pattern&match) (read-case-sensitive #t) (teachpacks ((lib "gui.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "gui.rkt" "teachpack" "htdp")))))
;#lang scheme
